...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .catch((e) => {
        if (mounted) setErr(e instanceof Error ? e.message : "Erro ao carregar dashboard.");
      })
      .finally(() => {
  ...
  return (
    <div>
      ...
      <section className="mb-8">
        <h2 className="mb-4 text-sm font-semibold text-zinc-800">Usuários</h2>
      ...
      <section>
        ...
        {loading ? (
          ...
          <p className="text-sm text-zinc-500">
            Nenhum documento publicado ainda. Vá em <strong>Upload Book</strong> para criar o
            primeiro.
          </p>
        ) : (
