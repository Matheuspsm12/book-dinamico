...
public enum AuditoriaAcaoEnum {
    ...
    CRIAR_USUARIO(EntidadeAuditoriaEnum.USUARIO, AcaoBaseAuditoriaEnum.CRIAR),
    ALTERAR_USUARIO(EntidadeAuditoriaEnum.USUARIO, AcaoBaseAuditoriaEnum.ALTERAR),
    OCIOSIDADE_USUARIO(EntidadeAuditoriaEnum.USUARIO, AcaoBaseAuditoriaEnum.INATIVIDADE),
