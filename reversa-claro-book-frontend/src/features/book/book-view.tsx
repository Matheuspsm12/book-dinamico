    ...
    <div className="flex flex-col items-center">
      <div className="claro-card flex w-[220px] flex-col items-center justify-between px-6 py-7 text-center">
        <div className="flex h-[110px] flex-col items-center justify-center">
          <p className="font-extrabold text-base uppercase leading-tight tracking-wide">
            {doc.nome}
          </p>
    ...
    <div className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div className="relative z-10 grid min-h-screen grid-cols-[1fr_320px]">
        <div className="flex flex-col px-12 py-10">
          ...
          <div className="-mx-12 bg-zinc-900 px-12 py-4 text-center font-bold text-sm text-white uppercase tracking-[0.2em]">
            Conectando dados, impulsionando resultados
          </div>
        </div>

        <aside className="flex flex-col bg-[var(--claro-red)] px-6 py-12 text-white">
          <h3 className="text-center font-bold text-base uppercase tracking-wide">
            Última Atualização
          </h3>
          ...
          <div className="mt-6 space-y-3">
            ...
            {docs.map((d) => (
              <div
                key={d.id}
                className="group relative rounded-md bg-white/15 p-4 text-white text-xs"
              >
                ...
                {isAdmin && (
                  <div className="mt-3 flex justify-center gap-2 border-white/20 border-t pt-3">
                    <button
                      type="button"
                      onClick={() => setEditando(d)}
                      className="inline-flex items-center gap-1 rounded bg-white/10 px-2 py-1 font-semibold text-[10px] uppercase hover:bg-white/25"
